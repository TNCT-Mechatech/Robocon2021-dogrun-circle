    ...
    if(flg == 0){
        if(!ball_datas.empty()){
            ...
            if(array_co != 0){
                ...
                if(70000<size && size<80000 && -100<x && x<100){
                    flg = 1;
                    yaw = 0;
                    ver = 0;
                    ofsc_flg = 0;
        ...
        if(!house_datas.empty()){
            ...
            if(array_co != 0){
                ...
                ver = ver_move(house_datas, array_num, 200000, 50);

                shake.data = 0;
                shake_flg = 0;
                shippo.data = 1;
                ROS_INFO("%f %f %f", x, house_datas[array_num].size_x, size);
                ...
                if(house_datas[array_num].size_x > 200){
                    flg = 3;
                    yaw = 0;
                    ver = 0;
                    ofsc_flg = 0;
...
int main(int argc, char** argv){
    ros::init(argc, argv, "dogrun_house");
    ros::NodeHandle pnh("~");
